...
export async function updateSession(request: NextRequest) {
    ...
    // Protect all /admin and /api/upload routes
    const isProtectedRoute = request.nextUrl.pathname.startsWith('/admin') || request.nextUrl.pathname.startsWith('/api/upload')
